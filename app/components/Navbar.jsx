...
const Navbar = () => {
   ...
   return (
    <>
    {/* Site Built By Me Button - Mobile Only (Bottom of Screen) */}
 ...
 {/* mobile menu */}
        <ul ref={sideMenuRef} className='translate-x-full min-h-[100dvh] flex md:hidden flex-col gap-4 py-20 px-10 fixed -right-0 top-0 bottom-0        
        ...
        <p className='text-xs bg-white rounded-full px-4 py-2 text-gray-600 text-left shadow-sm'>Built by me</p>
    </div>
        </ul>
      </nav>
    </>
